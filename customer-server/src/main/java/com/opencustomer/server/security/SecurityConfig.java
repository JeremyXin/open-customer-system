 ...
 * JWT-based stateless authentication with WebSocket and visitor endpoint support.
 */
@Configuration
@EnableWebSecurity
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Visitor endpoints (widget) - auth handled by X-Visitor-Token in controllers
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/conversations/{id}/messages").permitAll()
